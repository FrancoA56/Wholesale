  ...
  return (
    <>
      ...
      <div className="sm:grid sm:grid-cols-3 flex flex-col">
        <div className="sm:w-9/12 w-11/12 sm:ml-20 ml-4 mr-4 sm:mr-0 my-12 sm:col-span-2">
          <CarouselProvider
        ...
        <div className="sm:col-span-1 flex text-justify items-center sm:mr-28 sm:ml-0 mr-4 ml-4">
